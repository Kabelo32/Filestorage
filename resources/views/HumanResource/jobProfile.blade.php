        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-gray-200 text-gray-900 flex justify-between items-center">
                    <h1 class="text-2xl font-semibold">Job Profile Documents</h1>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6 mb-6">
                ...
                <form action="{{ route('HumanResource.jobProfile.upload') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
            ...
            @foreach($files as $file)
                <li class="flex justify-between items-center border-b pb-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <!-- Delete Button -->
                         <!-- Delete Button -->
                         <form action="{{ route('HumanResource.delete', ['type' => 'jobProfile', 'id' => $file->id]) }}" method="POST">
    @csrf
    @method('DELETE')
